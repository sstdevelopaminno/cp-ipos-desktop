...
import "./settings-mdm-lite-runtime";
import "./settings-popup-stabilizer";
import "./settings-storage-cleanup-runtime";
...
import "./settings-mdm-lite-runtime.css";
import "./settings-popup-stabilizer.css";
import "./settings-storage-cleanup-runtime.css";
import "./restaurant-discount-ui.css";
