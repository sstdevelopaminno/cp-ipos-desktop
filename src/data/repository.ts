...
export type ProductInput = Omit<Product, "id" | "active"> & { id?: string; active?: boolean };
...
export type StockInput = { productId: string; movementType: "in" | "out" | "adjustment"; quantity: number; reason: string; staff: Staff; shiftId?: string };
